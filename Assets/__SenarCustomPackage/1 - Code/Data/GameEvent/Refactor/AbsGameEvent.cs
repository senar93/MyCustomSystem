namespace MyCustomSystem.Events
{
	...
	public abstract class AbsGameEvent<GameEventListener> : SerializedScriptableObject, 
															IGameEvent<GameEventListener>, 
															ISerializationCallbackReceiver
		where GameEventListener : IGameEventListener
	{
		...
		{
			return listeners.Find(x => Comparer.Equals(x, listener)) != null;
		}
